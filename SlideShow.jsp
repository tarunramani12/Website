        ...
        <table width="100%" height="100%" align=center>
            ...
            <td style="background-color: white; padding: 10px;">
                ...
                <span class="menu-tabs-span">
                    ...
                    <a href="CV&Contact.jsp" class="inactive">CV & CONTACT</a>
                        ...
                        <span class="dropdown"><a href="WelcomePage.jsp" class="inactive">Hi, Joe</a>
            ...
            <td style="padding: 10px; max-width: 1200px;">
                <div class="middle-div">
                    ...
                    <%
                    String str = "https://www.youtube.com/embed/il_t1WVLNxk"
                    %>
                    <div id="mydiv" style="display: none">
                    <iframe style="margin-left: auto; margin-right: auto; max-width: 700px;" 
                        src="<%=str%>"> 
                    </iframe>
                    ...
                    <button onclick="displayvideo()">Click</button>


                    <script>
                    function displayvideo() {
                        var c = document.getElemebtById("mydiv");
